...
import Server.GetRequestHandlers.EventHandler;
import Server.GetRequestHandlers.EventIDHandler;
import Server.GetRequestHandlers.PersonHandler;
import Server.GetRequestHandlers.PersonIDHandler;
import Server.PostRequestHandlers.*;
...
public class Server {
	...
	private void run(String portNumber) {
		...
		// Creat and install the HTTP handler for the "/" URL path for file.
